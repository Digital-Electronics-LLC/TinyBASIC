        ...
        ; Interactive syntax:
        ;
        ; Line entry is done with keyboard, finish with Enter
        ;
        ; Backspace can be used, don't be fooled by the fact
        ; that screen isn't deleted (it's right in buffer).
        ;
        ...
        ;   list
        ;
        ; To exit to command-line (only COM file):
        ;   system
        ;
        ; Statements:
        ...
        ;   common precendence rules and signed operation.
        ;
...
start:
    ...
    %endif
        ...
        ;
main_loop:
        mov sp,stack    ; Reinit stack pointer
...
f5:     mov cl,[di]     ; Read length of the string
        mov ch,0
        test cx,cx      ; Is it zero?
        je f4           ; Yes, jump
...
f1:     call input_key  ; Read keyboard
        ...
        jmp f1          ; Wait another key

f2:     stosb           ; Save key in buffer
